...
* DT2[2:0] = 0, N/A.
* DT2[2:0] = 1, N/A.
* DT2[2:0] = 2, the `o_time_rst` signal is set for 8 `t_clk` clock cycles and then goes to zero again.
* DT2[2:0] = 3, the `o_time_update` signal is set for 8 `t_clk` clock cycles and then goes to zero again.
* DT2[2:0] = 4, the `o_core_start` signal is set for 8 `t_clk` clock cycles and then goes to zero again.
* DT2[2:0] = 5, the `o_core_stop` signal is set for 8 `t_clk` clock cycles and then goes to zero again.
* DT2[2:0] = 6, the `o_proc_start` signal is set for 8 `t_clk` clock cycles and then goes to zero again.
* DT2[2:0] = 7, the `o_proc_stop` signal is set for 8 `t_clk` clock cycles and then goes to zero again.
