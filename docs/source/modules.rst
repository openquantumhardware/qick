...
(:doc:`/firmware/generators/index`, :doc:`/firmware/readouts/index`, :doc:`/tprocv2_trm`, ...) already
...
:doc:`/firmware/index` for what's on your board). :mod:`qick.rfboard` extends it
...
modules directly -- see :doc:`/firmware/generators/index`, :doc:`/firmware/readouts/index`, and
...
:doc:`/firmware/support_cores` if you were looking for the ``axis_streamer`` RTL
