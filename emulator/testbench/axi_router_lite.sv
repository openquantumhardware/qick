...
module axi_router_lite #(
    ...
    always_comb begin
        ...
        // Signal Generator 1 (base 0x4001_D000, 6-bit addr)
        if ((m_axi_awaddr & MASK_SG1) == BASE_SG1) begin
            write_slave_sel[5] = 1'b1;
            write_awready[5] = s_sg1_awready;
            write_slave_valid[5] = m_axi_awvalid & 1'b1;
        end
    end
    ...
    always_comb begin
        ...
        s_sg1_awvalid = m_axi_awvalid & write_slave_sel[5];
    end
    ...
    always_comb begin
        ...
        s_sg0_wvalid = m_axi_wvalid & write_data_sel[1];
        ...
        s_sg1_wvalid = m_axi_wvalid & write_data_sel[5];
    end
    ...
    always_comb begin
        ...
        // Signal Generator 1 (base 0x4001_D000, 6-bit addr)
        if ((m_axi_araddr & MASK_SG1) == BASE_SG1) begin
            read_slave_sel[5] = 1'b1;
            read_slave_ready[5] = s_sg1_arready;
            read_slave_valid[5] = m_axi_arvalid & 1'b1;
        end
    end
    ...
    always_comb begin
        ...
        s_sg1_arvalid = m_axi_arvalid & read_slave_sel[5];
    end
