...
assign sreg_32_dt[3]  = status_i ;
assign sreg_32_dt[4]  = reg_div_i[0]       ;
assign sreg_32_dt[5]  = reg_div_i[1]       ;
assign sreg_32_dt[6]  = reg_arith_i ;
assign sreg_32_dt[7]  = tproc_ext_i [0]    ; 
assign sreg_32_dt[8]  = tproc_ext_i [1]    ;
assign sreg_32_dt[9]  = reg_port_i [0]  ;
assign sreg_32_dt[10] = reg_port_i [1] ;
