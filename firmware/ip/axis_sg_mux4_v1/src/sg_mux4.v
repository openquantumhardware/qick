...
input	[15:0]			PINC0_REG;
input	[15:0]			PINC1_REG;
input	[15:0]			PINC2_REG;
input	[15:0]			PINC3_REG;
input					WE_REG;
...
// PINC registers vector.
wire	[15:0]	PINC_REG_v	[0:N_OUT-1];
...
reg  signed [17:0]	add0_imag_r	[0:N_DDS-1];
reg  signed [17:0]	add1_real_r	[0:N_DDS-1];
reg  signed [17:0]	add1_imag_r	[0:N_DDS-1];
reg  signed [17:0]	add2_real_r	[0:N_DDS-1];
reg  signed [17:0]	add2_imag_r	[0:N_DDS-1];
reg  signed [17:0]	add3_real_r	[0:N_DDS-1];
reg  signed [17:0]	add3_imag_r	[0:N_DDS-1];

// Addition results.
wire signed [17:0]	sum0_real	[0:N_DDS-1];
wire signed [17:0]	sum0_imag	[0:N_DDS-1];
wire signed [17:0]	sum1_real	[0:N_DDS-1];
wire signed [17:0]	sum1_imag	[0:N_DDS-1];
wire signed [17:0]	sum2_real	[0:N_DDS-1];
wire signed [17:0]	sum2_imag	[0:N_DDS-1];
reg  signed [17:0]	sum0_real_r	[0:N_DDS-1];
reg  signed [17:0]	sum0_imag_r	[0:N_DDS-1];
reg  signed [17:0]	sum1_real_r	[0:N_DDS-1];
reg  signed [17:0]	sum1_imag_r	[0:N_DDS-1];
reg  signed [17:0]	sum2_real_r	[0:N_DDS-1];
reg  signed [17:0]	sum2_imag_r	[0:N_DDS-1];
	...
	for (i=0; i<N_DDS; i=i+1) begin : GEN_add
		...
		always @(posedge aclk) begin
			if (~aresetn) begin
				...
				add0_imag_r	[i] <= {{2{add0_imag[i][15]}},add0_imag[i]};
				add1_real_r	[i] <= {{2{add1_real[i][15]}},add1_real[i]};
				add1_imag_r	[i] <= {{2{add1_imag[i][15]}},add1_imag[i]};
				add2_real_r	[i] <= {{2{add2_real[i][15]}},add2_real[i]};
				add2_imag_r	[i] <= {{2{add2_imag[i][15]}},add2_imag[i]};
				add3_real_r	[i] <= {{2{add3_real[i][15]}},add3_real[i]};
				add3_imag_r	[i] <= {{2{add3_imag[i][15]}},add3_imag[i]};
		...
		assign sum2_imag[i]	= sum0_imag_r[i] + sum1_imag_r[i];
		...
		assign dout_imag[i] =	(qsel_la == 1)?	sum2_imag_r[i][15:0]	:
								(qsel_la == 2)? sum2_imag_r[i][16:1]	:
								sum2_imag_r[i][17:2];
