// std_readout_top: Standard readout module with emulator support
// Original version for synthesis (VHDL modules). For emulation, use EMULATOR=1 to use behavioral models.
...
end else begin : gen_sync_emu
    // SystemVerilog behavioral model for emulation
    synchronizer_n_sv #(
        .N(2)
    ) WE_REG_resync_i 
    (
...
if (!EMULATOR) begin : gen_fifo_synth
    ...
    // Behavioral model for emulation
    fifo_behav
    #(
        // Data width.
        .B    (83),
