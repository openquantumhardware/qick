...
module fir_axis_model_sv #(
    ...
    logic [LATENCY-1:0] valid_pipe = '0;
    logic [TLAST_LATENCY-1:0] last_pipe = '0;
    logic [EVENT_LATENCY-1:0] data_missing_pipe = '0;
    logic [EVENT_LATENCY-1:0] data_unexpected_pipe = '0;
    logic [EVENT_LATENCY-1:0] config_missing_pipe = '0;
    logic [EVENT_LATENCY-1:0] config_unexpected_pipe = '0;
