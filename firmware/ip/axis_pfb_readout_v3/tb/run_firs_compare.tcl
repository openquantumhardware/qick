...
add_files -norecurse [file normalize "$src_dir/verilog/pfb_ctrl_pkg_sv.sv"]
add_files -norecurse [file normalize "$src_dir/verilog/pfb_cfg_sv.sv"]
add_files -norecurse [file normalize "$src_dir/verilog/pfb_framing_sv.sv"]
add_files -norecurse [file normalize "$src_dir/verilog/pfb_ctrl_sv.sv"]
add_files -norecurse [file normalize "$src_dir/verilog/zn_nb_sv.sv"]
