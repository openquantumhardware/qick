...
// selection block.
//
// The number of outputs is fixed to 8 in this case.
module pfb_top
	#(
		// Number of channels.
		parameter N = 32,
...
assign regs [4] = ID4_REG;
assign regs [5] = ID5_REG;
assign regs [6] = ID6_REG;
assign regs [7] = ID7_REG;
...
assign m4_axis_tdata	= dout [4];
assign m5_axis_tdata	= dout [5];
assign m6_axis_tdata	= dout [6];
assign m7_axis_tdata	= dout [7];
