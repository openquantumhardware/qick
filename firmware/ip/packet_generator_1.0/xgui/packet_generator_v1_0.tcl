...
proc init_gui { IPINST } {
  ...
  ipgui::add_static_text $IPINST -name "Description" -parent ${Page_0} -text {The AXIS Packet Generator is used to convert free running AXI-Stream interfaces, into AXI-Stream packets. This core is useful for transferring data to an AXI DMA.

The clock and reset ports are tied to the AXI-Lite and AXI-Stream interfaces.

}
  ipgui::add_param $IPINST -name "C_S_AXIS_DATA_WIDTH" -parent ${Page_0} -widget comboBox
