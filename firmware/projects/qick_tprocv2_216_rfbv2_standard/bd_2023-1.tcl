...
proc create_hier_cell_rfb_control { parentCell nameHier } {
  ...
  set bias_spi_bits [ create_bd_cell -type ip -vlnv FNAL:QICK:qick_vec2bit:1.0 bias_spi_bits ]
  set_property CONFIG.IN_DW {4} $bias_spi_bits


  # Create instance: brd_sel_bits, and set properties
  set brd_sel_bits [ create_bd_cell -type ip -vlnv FNAL:QICK:qick_vec2bit:1.0 brd_sel_bits ]
  set_property CONFIG.IN_DW {4} $brd_sel_bits


  # Create instance: filter_spi_bits, and set properties
  set filter_spi_bits [ create_bd_cell -type ip -vlnv FNAL:QICK:qick_vec2bit:1.0 filter_spi_bits ]
...
\
  ...
  set qick_vec2bit_led [ create_bd_cell -type ip -vlnv FNAL:QICK:qick_vec2bit:1.0 qick_vec2bit_led ]
  set_property -dict [list \
    CONFIG.IN_DW {8} \
    CONFIG.OUT_QTY {8} \
  ] $qick_vec2bit_led
  ...
  set qick_vec2bit_gpio [ create_bd_cell -type ip -vlnv FNAL:QICK:qick_vec2bit:1.0 qick_vec2bit_gpio ]
  set_property -dict [list \
    CONFIG.IN_DW {8} \
    CONFIG.OUT_QTY {8} \
  ] $qick_vec2bit_gpio
  ...
  set axis_dyn_readout_v1_2 [ create_bd_cell -type ip -vlnv FNAL:QICK:axis_dyn_readout_v1:1.0 axis_dyn_readout_v1_2 ]

  # Create instance: sg_translator_18, and set properties
  set sg_translator_18 [ create_bd_cell -type ip -vlnv FNAL:QICK:sg_translator:1.0 sg_translator_18 ]
  ...
  set axis_avg_buffer_10 [ create_bd_cell -type ip -vlnv FNAL:QICK:axis_avg_buffer:1.2 axis_avg_buffer_10 ]
  set_property -dict [list \
    CONFIG.N_AVG {13} \
    CONFIG.N_BUF {12} \
  ] $axis_avg_buffer_10
