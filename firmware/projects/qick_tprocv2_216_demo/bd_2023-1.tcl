...
FNAL:QICK:axis_resampler_2x1_v1:1.0\
FNAL:QICK:axis_sg_mux8_v1:1.0\
...
proc create_root_design { parentCell } {
  ...
  set axis_resampler_2x1_v1_0 [ create_bd_cell -type ip -vlnv FNAL:QICK:axis_resampler_2x1_v1:1.0 axis_resampler_2x1_v1_0 ]

  # Create instance: axis_sg_mux8_v1_0, and set properties
  set axis_sg_mux8_v1_0 [ create_bd_cell -type ip -vlnv FNAL:QICK:axis_sg_mux8_v1:1.0 axis_sg_mux8_v1_0 ]
  ...
  set axis_pfb_readout_v3_0 [ create_bd_cell -type ip -vlnv FNAL:QICK:axis_pfb_readout_v3:1.0 axis_pfb_readout_v3_0 ]
  ...
  set axis_readout_v3_0 [ create_bd_cell -type ip -vlnv FNAL:QICK:axis_readout_v3:1.0 axis_readout_v3_0 ]
