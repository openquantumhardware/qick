...
proc create_root_design { parentCell } {
  ...
  set axis_constant_0 [ create_bd_cell -type ip -vlnv FNAL:QICK:axis_constant:1.0 axis_constant_0 ]
  set_property -dict [ list \
   CONFIG.DATA_WIDTH {64} \
 ] $axis_constant_0

  # Create instance: axis_constant_1, and set properties
  set axis_constant_1 [ create_bd_cell -type ip -vlnv FNAL:QICK:axis_constant:1.0 axis_constant_1 ]
  set_property -dict [ list \
   CONFIG.DATA_WIDTH {64} \
 ] $axis_constant_1
  ...
  set axis_terminator_0 [ create_bd_cell -type ip -vlnv FNAL:QICK:axis_terminator:1.0 axis_terminator_0 ]
  set_property -dict [ list \
   CONFIG.DATA_WIDTH {256} \
 ] $axis_terminator_0

  # Create instance: axis_terminator_1, and set properties
  set axis_terminator_1 [ create_bd_cell -type ip -vlnv FNAL:QICK:axis_terminator:1.0 axis_terminator_1 ]
  set_property -dict [ list \
   CONFIG.DATA_WIDTH {256} \
 ] $axis_terminator_1
