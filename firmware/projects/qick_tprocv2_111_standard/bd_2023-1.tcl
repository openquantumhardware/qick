...
proc create_root_design { parentCell } {
  ...
  set axis_signal_gen_v6_7 [ create_bd_cell -type ip -vlnv Fermilab:QICK:axis_signal_gen_v6:1.0 axis_signal_gen_v6_7 ]
...
\
  ...
  set axis_dyn_readout_v1_3 [ create_bd_cell -type ip -vlnv Fermilab:QICK:axis_dyn_readout_v1:1.0 axis_dyn_readout_v1_3 ]
