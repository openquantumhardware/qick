set clk_axi  [get_clocks -of_objects [get_nets -of_objects [get_pins -hier -filter {name =~ */zynq_ultra_ps_e_0/pl_clk0}]]]
set clk_adc0 [get_clocks -of_objects [get_nets -of_objects [get_pins -hier -filter {name =~ */usp_rf_data_converter_0/clk_adc0}]]]
