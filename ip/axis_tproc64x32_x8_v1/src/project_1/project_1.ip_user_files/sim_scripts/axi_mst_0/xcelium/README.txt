...
#
# Generated by export_simulation on Fri May 21 13:58:21 CDT 2021
#
################################################################################
...
'-reset_run' switch to the './axi_mst_0.sh' script.

./axi_mst_0.sh -reset_run
...
./axi_mst_0.sh -noclean_files

For more information on the script, please type './axi_mst_0.sh -help'.
