...
#
# Generated by export_simulation on Fri May 21 13:58:23 CDT 2021
#
################################################################################
...
'-reset_run' switch to the './axis_mst_0.sh' script.

./axis_mst_0.sh -reset_run
...
./axis_mst_0.sh -noclean_files

For more information on the script, please type './axis_mst_0.sh -help'.
