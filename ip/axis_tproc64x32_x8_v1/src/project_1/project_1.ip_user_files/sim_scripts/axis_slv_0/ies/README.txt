...
#
# Generated by export_simulation on Fri May 21 13:58:24 CDT 2021
#
################################################################################
...
'-reset_run' switch to the './axis_slv_0.sh' script.

./axis_slv_0.sh -reset_run
...
./axis_slv_0.sh -noclean_files

For more information on the script, please type './axis_slv_0.sh -help'.
