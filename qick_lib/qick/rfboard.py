...
class AxisSignalGenV3(SocIP):
    ...
    # * 1 : enable writes.
    #
    bindto = ['Fermilab:QICK:axis_signal_gen_v3:1.0']
...
class AxisSignalGenV3Ctrl(SocIP):
    ...
    # ADDR_REG
    bindto = ['Fermilab:QICK:axis_signal_gen_v3_ctrl:1.0']
...
class AxisSignalGenV6Ctrl(SocIP):
    ...
    # * 0 : disable.
    # * 1 : enable.
    bindto = ['Fermilab:QICK:axis_signal_gen_v6_ctrl:1.0']
...
class AxisDdsMrSwitch(SocIP):
    ...
    # * 1 : imaginary part.
    #
    bindto = ['Fermilab:QICK:axis_dds_mr_switch:1.0']
...
class AxisSwitchV1(SocIP):
    bindto = ['Fermilab:QICK:axis_switch_v1:1.0']
